               ...
               <nav class="main-menu">
                  ...
                  <div id="navbar" class="navbar-collapse collapse">
                     <ul class="nav navbar-nav">
                        ...
                        <li><a class="active" data-scroll href="Vaccination.html">Vaccination</a></li>
      ...
      <%
        ...
        if (request.getMethod().equalsIgnoreCase("POST")) {
            ...
            String dbPassword = "";
                ...
                // Variables for Vaccine Registration form
                ...
                String ChronicHealthCondition = request.getParameter("ChronicHealthCondition");
                String DiagnosedWith = request.getParameter("DiagnosedWith");
                String FurtherDetails = request.getParameter("FurtherDetails");

                String InformationAreAccurate = request.getParameter("InformationAreAccurate");
                ...
                try {
                    ...
                    // SQL Insert Query
                    String sql = "INSERT INTO vaccineregistration (FirstName, LastName, AadharNumber, BirthDate, Gender, Email, PhoneNumber, StreetAddress, StreetAddressLine2, City, State, PinCode, InsuranceCompany, InsuranceID, ChronicHealthCondition, DiagnosedWith, FurtherDetails, InformationAreAccurate) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
                    ...
                    preparedStatement.setString(9, StreetAddressLine2);
                    preparedStatement.setString(10, City);
                    preparedStatement.setString(11, State);
                    preparedStatement.setString(12, PinCode);

                    preparedStatement.setString(13, InsuranceCompany);
                    preparedStatement.setString(14, InsuranceID);
                    preparedStatement.setString(15, ChronicHealthCondition);
                    preparedStatement.setString(16, DiagnosedWith);
                    preparedStatement.setString(17, FurtherDetails);

                    preparedStatement.setString(18, InformationAreAccurate);
                            ...
                            <div class="text-center">
                                ...
                                <p class="form-subHeader">
                                    Dear <%=request.getParameter("FirstName")%> <%=request.getParameter("LastName")%>,<br/>
                                        Thank you for submitting your Vaccine Registration form! We look forward to seeing you at the center on Vaccine Registration day.
                                </p>
                                </div>
                            </div>
                        </div>
