               ...
               <nav class="main-menu">
                  ...
                  <div id="navbar" class="navbar-collapse collapse">
                     <ul class="nav navbar-nav">
                        ...
                        <li><a class="active" data-scroll href="Donation.html">Donation</a></li>
   ...
   <%
      ...
      if (request.getMethod().equalsIgnoreCase("POST")) {
         ...
         String dbPassword = "";
               ...
               // Variables for payment form
               
               String FullName = request.getParameter("FullName");
               String PhoneNumber = request.getParameter("PhoneNumber");
               String Email = request.getParameter("Email");
               String Amount = request.getParameter("Amount");
               String CardLast4No = request.getParameter("CardLast4No");
               String PaymentSuccessful = "Y";
               
               if (CardLast4No.length() > 4) {
               ...
               try {
                  ...
                  // SQL Insert Query
                  String sql = "INSERT INTO paymentdetails (FullName, PhoneNumber, Email, Amount, CardLast4No, PaymentSuccessful) VALUES (?, ?, ?, ?, ?, ?)";
                  preparedStatement = connection.prepareStatement(sql);
                  preparedStatement.setString(1, FullName);
                  preparedStatement.setString(2, PhoneNumber);
                  preparedStatement.setString(3, Email);
                  preparedStatement.setString(4, Amount);
                  preparedStatement.setString(5, CardLast4No);
                  preparedStatement.setString(6, PaymentSuccessful);
                  ...
                  <div class="panel panel-default">
                     ...
                     <div>
                        <h4 class="panel-title">
                           &nbsp;&nbsp;Dear <%=request.getParameter("FullName")%>,<br/><br/>
                           &nbsp;&nbsp;Thank you for your payment! We have successfully received your payment of Rs. <%=request.getParameter("Amount")%>.
                        </h4>
                     </div>
                  </div>
               </div>
      <%
                     ...
                     out.println("<h3>Failed to do entry of payment Rs. " + request.getParameter("Amount") + ".</h3>");
                  }
               } catch (Exception e) {
                  e.printStackTrace();
